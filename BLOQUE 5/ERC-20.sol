...
interface IERC20 {
    ...
    // Devuelve un valor booleano con el resultado de la operacíon de paso de una cantidad de tokens usando el metodo allowance()
...
contract ERC20Basic is IERC20 {
    ...
    string public constant name = "KalomToken";
